...
elseif(!in_array($_FILES['mypicture']['type'],['image/jpeg','image/png','image/gif','image/bmp']))
{
    ...
    try{
        ...
        $dsn = "mysql:host=localhost;dbname=shoeshop55122005125;charset=utf8";
        $dbusername = "root";
        $dbuserpwd = "root";
        ...
        $sql = "insert into account55122005125 values(null, :uname, :upwd,
        :usex, :uaddress, :uemail, :uphone, :ubirth, :uhobby, :uimagefile)";
